...
def main():
    ...
    with FizzBuzzer(10) as fizz_buzz:
        ...
        for i in range(1000):
            number = a[i]
            if(fizz_buzz.predict(int(number))=="Fizz"):
                div_7=np.append(div_7,number)
            elif(fizz_buzz.predict(int(number))=="Buzz"):
                div_11=np.append(div_11,number)
            elif(fizz_buzz.predict(int(number))=="FizzBuzz"):
                div_77=np.append(div_77,number)
            else:
                continue
    print("numbers divisible by 7:",end="")
    print(div_7)
    print("\n")
    print("numbers divisible by 11:",end="")
    print(div_11)
    print("\n")
    print("numbers divisible by 77:",end="")
    print(div_77)
